...
const file_proto_search_proto_rawDesc = "" +
	...
	"\x0fUpdateCandidate\x12\x1e.search.UpdateCandidateRequest\x1a\x1f.search.UpdateCandidateResponse2\xc2\x02\n" +
...
var file_proto_search_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
var file_proto_search_proto_depIdxs = []int32{
	...
	16, // 3: search.SearchResult.content:type_name -> google.protobuf.Struct
	...
	6,  // 7: search.CandidateService.GetEnrichmentData:input_type -> search.EnrichmentRequest
	3,  // 8: search.CandidateService.GetSectors:input_type -> search.GetSectorsRequest
	14, // 9: search.CandidateService.UpdateCVProgress:input_type -> search.UpdateCVProgressRequest
	0,  // 10: search.CandidateService.GetJobRoles:input_type -> search.GetJobRolesRequest
	11, // 11: search.SearchService.Search:output_type -> search.SearchResponse
	13, // 12: search.SearchService.UpdateCandidate:output_type -> search.UpdateCandidateResponse
	8,  // 13: search.CandidateService.GetEnrichmentData:output_type -> search.EnrichmentResponse
	5,  // 14: search.CandidateService.GetSectors:output_type -> search.GetSectorsResponse
	15, // 15: search.CandidateService.UpdateCVProgress:output_type -> search.UpdateCVProgressResponse
	2,  // 16: search.CandidateService.GetJobRoles:output_type -> search.GetJobRolesResponse
