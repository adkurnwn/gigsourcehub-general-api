...
-- Create "role_applieds" table
CREATE TABLE "public"."role_applieds" ("id" uuid NOT NULL, "name" character varying(150) NOT NULL, "sector_id" uuid NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "deleted_at" timestamptz NULL, PRIMARY KEY ("id"));
-- Create index "idx_role_applieds_deleted_at" to table: "role_applieds"
CREATE INDEX "idx_role_applieds_deleted_at" ON "public"."role_applieds" ("deleted_at");
-- Create index "idx_role_applieds_sector_id" to table: "role_applieds"
CREATE INDEX "idx_role_applieds_sector_id" ON "public"."role_applieds" ("sector_id");
