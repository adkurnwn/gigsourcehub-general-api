-- Seeder for RECRUITMENT_STATUS
INSERT INTO recruitment_status (id, name, is_active, created_at, updated_at) VALUES
...
-- Seeder for ROLE_SYSTEM
INSERT INTO role_system (id, name, created_at, updated_at) VALUES
...
-- Seeder for ROLE_APPLIED (Linking to SECTOR 'Information Technology')
INSERT INTO role_applied (id, name, sector_id, created_at, updated_at) VALUES
