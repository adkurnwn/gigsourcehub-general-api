...
-- Modify "users" table
ALTER TABLE "public"."users" ADD CONSTRAINT "user_kabupaten_kota_fk" FOREIGN KEY ("kabupaten_kota_id") REFERENCES "public"."kabupaten_kota" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "user_recruitment_status_fk" FOREIGN KEY ("recruitment_status_id") REFERENCES "public"."recruitment_statuses" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "user_assigned_role_fk" FOREIGN KEY ("assigned_role_id") REFERENCES "public"."job_roles" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "user_system_role_fk" FOREIGN KEY ("system_role_id") REFERENCES "public"."system_roles" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
